...
namespace Pixension
{
    public class GameManager : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            // Generiere zuf�lligen Seed wenn nicht gesetzt
            if (seed == 0)
            {
        ...
        private void LoadRegistries()
        {
            ...
            // Structure Loader (l�dt automatisch alle Strukturen)
        ...
        private void LoadWorld()
        {
            ...
            if (saveLoadManager.SaveExists(saveToLoad))
            {
                ...
                if (success)
                {
                    ...
                    // Seed wird vom Save �berschrieben
        ...
        private void PreloadSpawnAreaAndSpawnPlayer()
        {
            ...
            // Rebuild Meshes f�r alle geladenen Chunks
            ...
            // Finde h�chsten Block an Spawn-Position
            ...
            Vector3 playerSpawnPos = new Vector3(
                ...
                spawnY + 1.5f, // +1 f�r �ber Block, +0.5 f�r Player-Center
